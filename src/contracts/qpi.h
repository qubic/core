...
#define X_MULTIPLIER 1ULL
	...
	#define PUBLIC_FUNCTION_WITH_LOCALS(function) \
		public: \
			enum { __is_function_##function = true }; \
			static void function(const QPI::QpiContextFunctionCall& qpi, CONTRACT_STATE_TYPE& state, function##_input& input, function##_output& output, function##_locals& locals) { ::__FunctionOrProcedureBeginEndGuard<(CONTRACT_INDEX << 22) | __LINE__> __prologueEpilogueCaller;
