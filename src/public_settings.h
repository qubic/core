...
constexpr unsigned long long CUSTOM_MINING_SOLUTION_STORAGE_SIZE = 8ULL << 30; // 1GB for custom mining solution storage. If set zeros, node will not record any custom mining solution
