...
static constexpr unsigned int HYPERIDENTITY_SOLUTION_THRESHOLD_DEFAULT = HYPERIDENTITY_NUMBER_OF_OUTPUT_NEURONS / 2 + HYPERIDENTITY_NUMBER_OF_OUTPUT_NEURONS / 2 * 5 / 100; // 
...
static constexpr unsigned int ADDITION_SOLUTION_THRESHOLD_DEFAULT = (1ULL << ADDITION_NUMBER_OF_INPUT_NEURONS) * ADDITION_NUMBER_OF_OUTPUT_NEURONS * 525 / 1000; //0.525 of max score
