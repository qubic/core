...
#define LOG_BUFFER_PAGE_SIZE 16384ULL //300000000ULL
#define PMAP_LOG_PAGE_SIZE 1000ULL // 30000000ULL
#define IMAP_LOG_PAGE_SIZE 10ULL //10000ULL
...
#define TICK_STORAGE_AUTOSAVE_TICK_PERIOD 50
