...
// TODO: add option for having locals to EXPAND procedures
...
typedef void (*MIGRATE_PROCEDURE)(const QPI::QpiContextFunctionCall&, void* state, void* oldState, void* locals); // cannot not change anything except state
