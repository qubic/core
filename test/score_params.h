...
// Bpp9000Params order: <inputNeurons, outputNeurons, seqLength, winWidth, maxTicks, neighbor, population, mutations, threshold, shiftCap>
// Thresholds are the frame-0 floor in frame units (winWidth * 45 / 100). These frames carry no calendar
// meaning, so the cap is scaled to the frame width instead of one week.
