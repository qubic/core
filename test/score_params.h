...
using Config0 = score_engine::Bpp9000Params<18, 1, 128, 32, 5000, 3, 128, 10, 76>;
using Config1 = score_engine::Bpp9000Params<18, 1, 512, 128, 20000, 3, 128, 15, 306>;
using Config2 = score_engine::Bpp9000Params<18, 1, 2048, 512, 80000, 3, 128, 20, 1228>;
using Config3 = score_engine::Bpp9000Params<18, 1, 8760, 672, 100000, 3, 128, 5, 6469>;
